                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select name="id_proof_type" class="form-select" required>
                                            ...
                                            <option value="Passport"  <?= $user['data']['id_proof_type'] == 'Passport' ? 'selected':''; ?> >Passport</option>
                                            <option value="ID Card"  <?= $user['data']['id_proof_type'] == 'ID Card' ? 'selected':''; ?> >ID Card</option>
                                        </select>
                                    </div>
                                </div>
