                ...
                <div class="col-md-4">
                    <div class="car-card sticky2">
                        ...
                        ?>
                            ...
                            <h5 class="title1 fs-16 mb-1">Per Hour <span class="float-end">£<?=$car['price_per_hour'];?>/hr</span></h5>
                            <h5 class="title1 fs-16 mb-1">Convenience Fee <span class="float-end">£5</span></h5>
                            <?php 
                            ...
                            <hr class="my-3">
                            <h5 class="title1 mb-1">Total Price <span class="float-end"> £<?= ($difference * $car['price_per_hour']) + $convenienceFee; ?></span></h5>
