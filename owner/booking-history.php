                ...
                <?php
                    $owner_id = $_SESSION['loggedInUser']['user_id'];
                        ...
                        $query = "SELECT b.*, b.id as booking_id, u.name as username, c.image, c.name as car_name 
                                  ...
                                  WHERE c.owner_id = '$owner_id' AND 
                                        (booking_status='completed' OR booking_status='cancelled') AND 
                                        b.end_date >= '$todayDate' 
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <img src="<?= '../'.$bookingsItem['image']; ?>" style="width: 50px;height: 50px;"
                                                    alt="Brand" />
                                                <?= $bookingsItem['car_name']; ?>
                                                <?php }else{ echo "No Image"; } ?>
                                            </td>
                                            <td><?= $bookingsItem['start_date']; ?></td>
                                            <td><?= $bookingsItem['end_date']; ?></td>
                                            ...
                                            <td>
                                                <a href="booking-view.php?booking_id=<?= $bookingsItem['booking_no'];?>"
                                                    class="btn mb-0 btn-success btn-sm">View</a>
                                            </td>
                                        </tr>
                                        <?php
                                            endforeach;
